...
type LbUdpMonitorObservation struct {
	...
	Tag []LbUdpMonitorTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbUdpMonitorParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LbUdpMonitorTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbUdpMonitorTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbUdpMonitorTagParameters struct {
