...
type IpSetObservation struct {
	...
	Tag []IpSetTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type IpSetParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []IpSetTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpSetTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpSetTagParameters struct {
