...
func Configure(p *config.Provider) {
	...
	p.AddResourceConfigurator("nsxt_policy_gateway_static_route_bfd_peer", func(r *config.Resource) {
		r.ShortGroup = shortGroup
		r.Kind = "PolicyGatewayStaticRouteBfdPeer"
		r.Version = version
	})
