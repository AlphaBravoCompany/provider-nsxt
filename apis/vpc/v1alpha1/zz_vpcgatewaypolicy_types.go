...
type VpcGatewayPolicyObservation struct {
	...
	// Set of opaque identifiers meaningful to the user
	Tag []VpcGatewayPolicyTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}

type VpcGatewayPolicyParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []VpcGatewayPolicyTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type VpcGatewayPolicyTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type VpcGatewayPolicyTagParameters struct {
...
// VpcGatewayPolicySpec defines the desired state of VpcGatewayPolicy
type VpcGatewayPolicySpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     VpcGatewayPolicyParameters `json:"forProvider"`
}

// VpcGatewayPolicyStatus defines the observed state of VpcGatewayPolicy.
type VpcGatewayPolicyStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        VpcGatewayPolicyObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// VpcGatewayPolicy is the Schema for the VpcGatewayPolicys API. <no value>
...
type VpcGatewayPolicy struct {
	...
	Spec   VpcGatewayPolicySpec   `json:"spec"`
	Status VpcGatewayPolicyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// VpcGatewayPolicyList contains a list of VpcGatewayPolicys
type VpcGatewayPolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []VpcGatewayPolicy `json:"items"`
}

// Repository type metadata.
var (
	VpcGatewayPolicy_Kind             = "VpcGatewayPolicy"
	VpcGatewayPolicy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: VpcGatewayPolicy_Kind}.String()
	VpcGatewayPolicy_KindAPIVersion   = VpcGatewayPolicy_Kind + "." + CRDGroupVersion.String()
	VpcGatewayPolicy_GroupVersionKind = CRDGroupVersion.WithKind(VpcGatewayPolicy_Kind)
)

func init() {
	SchemeBuilder.Register(&VpcGatewayPolicy{}, &VpcGatewayPolicyList{})
}
