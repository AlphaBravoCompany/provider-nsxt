...
type PolicyIpsecVpnSessionObservation struct {
	...
	Tag []PolicyIpsecVpnSessionTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyIpsecVpnSessionParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []PolicyIpsecVpnSessionTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyIpsecVpnSessionTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyIpsecVpnSessionTagParameters struct {
