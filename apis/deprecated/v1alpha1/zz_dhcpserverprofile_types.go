...
type DhcpServerProfileObservation struct {
	...
	Tag []DhcpServerProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type DhcpServerProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []DhcpServerProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type DhcpServerProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type DhcpServerProfileTagParameters struct {
