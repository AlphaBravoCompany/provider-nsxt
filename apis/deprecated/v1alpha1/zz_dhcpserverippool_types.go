...
type DhcpServerIpPoolObservation struct {
	...
	Tag []DhcpServerIpPoolTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type DhcpServerIpPoolParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []DhcpServerIpPoolTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type DhcpServerIpPoolTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type DhcpServerIpPoolTagParameters struct {
