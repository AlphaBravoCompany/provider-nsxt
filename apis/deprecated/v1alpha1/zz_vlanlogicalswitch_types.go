...
type VlanLogicalSwitchAddressBindingObservation struct {
...
type VlanLogicalSwitchAddressBindingParameters struct {
...
type VlanLogicalSwitchObservation struct {
	...
	AddressBinding []VlanLogicalSwitchAddressBindingObservation `json:"addressBinding,omitempty" tf:"address_binding,omitempty"`
	...
	SwitchingProfileID []VlanLogicalSwitchSwitchingProfileIDObservation `json:"switchingProfileId,omitempty" tf:"switching_profile_id,omitempty"`

	// Set of opaque identifiers meaningful to the user
	Tag []VlanLogicalSwitchTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type VlanLogicalSwitchParameters struct {
	...
	// Address bindings for the Logical switch
	// +kubebuilder:validation:Optional
	AddressBinding []VlanLogicalSwitchAddressBindingParameters `json:"addressBinding,omitempty" tf:"address_binding,omitempty"`
	...
	// List of IDs of switching profiles (of various types) to be associated with this object. Default switching profiles will be used if not specified
	// +kubebuilder:validation:Optional
	SwitchingProfileID []VlanLogicalSwitchSwitchingProfileIDParameters `json:"switchingProfileId,omitempty" tf:"switching_profile_id,omitempty"`

	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []VlanLogicalSwitchTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type VlanLogicalSwitchSwitchingProfileIDObservation struct {
...
type VlanLogicalSwitchSwitchingProfileIDParameters struct {
...
type VlanLogicalSwitchTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type VlanLogicalSwitchTagParameters struct {
