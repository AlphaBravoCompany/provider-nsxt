...
type LbHttpMonitorObservation struct {
	...
	Tag []LbHttpMonitorTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbHttpMonitorParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LbHttpMonitorTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbHttpMonitorTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbHttpMonitorTagParameters struct {
