...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"nsxt_edge_transport_node_rtep":                            config.IdentifierFromProvider,
	...
	"nsxt_policy_distributed_flood_protection_profile":         config.IdentifierFromProvider,
	"nsxt_policy_distributed_flood_protection_profile_binding": config.IdentifierFromProvider,
	...
	"nsxt_policy_firewall_exclude_list_member":                 config.IdentifierFromProvider,
	...
	"nsxt_policy_gateway_flood_protection_profile":             config.IdentifierFromProvider,
	"nsxt_policy_gateway_flood_protection_profile_binding":     config.IdentifierFromProvider,
	...
	"nsxt_policy_gateway_static_route_bfd_peer":                config.IdentifierFromProvider,
	"nsxt_policy_global_manager":                               config.IdentifierFromProvider,
	...
	"nsxt_policy_ipsec_vpn_tunnel_profile":                     config.IdentifierFromProvider,
	"nsxt_policy_l2_vpn_service":                               config.IdentifierFromProvider,
	"nsxt_policy_l2_vpn_session":                               config.IdentifierFromProvider,
	"nsxt_policy_lb_client_ssl_profile":                        config.IdentifierFromProvider,
	"nsxt_policy_lb_http_application_profile":                  config.IdentifierFromProvider,
	"nsxt_policy_lb_http_monitor_profile":                      config.IdentifierFromProvider,
	"nsxt_policy_lb_https_monitor_profile":                     config.IdentifierFromProvider,
	"nsxt_policy_lb_icmp_monitor_profile":                      config.IdentifierFromProvider,
	"nsxt_policy_lb_passive_monitor_profile":                   config.IdentifierFromProvider,
	"nsxt_policy_lb_pool":                                      config.IdentifierFromProvider,
	"nsxt_policy_lb_service":                                   config.IdentifierFromProvider,
	"nsxt_policy_lb_tcp_monitor_profile":                       config.IdentifierFromProvider,
	"nsxt_policy_lb_udp_monitor_profile":                       config.IdentifierFromProvider,
	...
	"nsxt_policy_metadata_proxy":                               config.IdentifierFromProvider,
	"nsxt_policy_nat_rule":                                     config.IdentifierFromProvider,
// "nsxt_policy_ospf_area":                                     config.IdentifierFromProvider, // cannot build types for PolicyOspfArea: cannot build the Types: got type "*float64" for field "KeyID", only types "string", "*string", []string, []*string, "map[string]string" and "map[string]*string" supported as sensitive
	"nsxt_policy_ospf_config":                                  config.IdentifierFromProvider,
	"nsxt_policy_parent_security_policy":                       config.IdentifierFromProvider,
	...
	"nsxt_policy_security_policy_rule":                         config.IdentifierFromProvider,
	...
	"nsxt_policy_share":                                        config.IdentifierFromProvider,
	"nsxt_policy_shared_resource":                              config.IdentifierFromProvider,
	"nsxt_policy_site":                                         config.IdentifierFromProvider,
	...
	"nsxt_policy_tier0_gateway_gre_tunnel":                     config.IdentifierFromProvider,
	...
	"nsxt_policy_tier0_inter_vrf_routing":                      config.IdentifierFromProvider,
	...
	"nsxt_upgrade_precheck_acknowledge":                        config.IdentifierFromProvider,
	"nsxt_upgrade_prepare":                                     config.IdentifierFromProvider,
	"nsxt_upgrade_run":                                         config.IdentifierFromProvider,
