...
type NsServiceGroupObservation struct {
	...
	Tag []NsServiceGroupTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type NsServiceGroupParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []NsServiceGroupTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type NsServiceGroupTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type NsServiceGroupTagParameters struct {
