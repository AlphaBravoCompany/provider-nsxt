...
type EdgeClusterObservation struct {
	...
	Tag []EdgeClusterTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type EdgeClusterParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []EdgeClusterTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type EdgeClusterTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type EdgeClusterTagParameters struct {
