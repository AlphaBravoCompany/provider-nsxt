...
type LbCookiePersistenceProfileObservation struct {
	...
	Tag []LbCookiePersistenceProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type LbCookiePersistenceProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LbCookiePersistenceProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbCookiePersistenceProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbCookiePersistenceProfileTagParameters struct {
