...
type LogicalRouterLinkPortOnTier1Observation struct {
	...
	Tag []LogicalRouterLinkPortOnTier1TagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type LogicalRouterLinkPortOnTier1Parameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LogicalRouterLinkPortOnTier1TagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalRouterLinkPortOnTier1TagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalRouterLinkPortOnTier1TagParameters struct {
