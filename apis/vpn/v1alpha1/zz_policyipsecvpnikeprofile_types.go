...
type PolicyIpsecVpnIkeProfileObservation struct {
	...
	Tag []PolicyIpsecVpnIkeProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type PolicyIpsecVpnIkeProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []PolicyIpsecVpnIkeProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyIpsecVpnIkeProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyIpsecVpnIkeProfileTagParameters struct {
