...
type SwitchSecuritySwitchingProfileObservation struct {
	...
	Tag []SwitchSecuritySwitchingProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type SwitchSecuritySwitchingProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []SwitchSecuritySwitchingProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type SwitchSecuritySwitchingProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type SwitchSecuritySwitchingProfileTagParameters struct {
