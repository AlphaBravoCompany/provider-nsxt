...
type LbSourceIpPersistenceProfileObservation struct {
	...
	Tag []LbSourceIpPersistenceProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbSourceIpPersistenceProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LbSourceIpPersistenceProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbSourceIpPersistenceProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbSourceIpPersistenceProfileTagParameters struct {
