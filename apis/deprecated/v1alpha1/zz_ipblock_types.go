...
type IpBlockObservation struct {
	...
	Tag []IpBlockTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type IpBlockParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []IpBlockTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpBlockTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpBlockTagParameters struct {
