...
type IpPoolObservation struct {
	...
	Tag []IpPoolTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type IpPoolParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []IpPoolTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpPoolTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpPoolTagParameters struct {
