...
type LbHttpApplicationProfileObservation struct {
	...
	Tag []LbHttpApplicationProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbHttpApplicationProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LbHttpApplicationProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbHttpApplicationProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbHttpApplicationProfileTagParameters struct {
