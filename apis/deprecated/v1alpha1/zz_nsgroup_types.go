...
type NsGroupMemberObservation struct {
...
type NsGroupMemberParameters struct {
...
type NsGroupObservation struct {
	...
	Member []NsGroupMemberObservation `json:"member,omitempty" tf:"member,omitempty"`
	...
	Tag []NsGroupTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type NsGroupParameters struct {
	...
	// Reference to the direct/static members of the NSGroup.
	// +kubebuilder:validation:Optional
	Member []NsGroupMemberParameters `json:"member,omitempty" tf:"member,omitempty"`
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []NsGroupTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type NsGroupTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type NsGroupTagParameters struct {
