...
type LogicalSwitchObservation struct {
	...
	SwitchingProfileID []LogicalSwitchSwitchingProfileIDObservation `json:"switchingProfileId,omitempty" tf:"switching_profile_id,omitempty"`

	// Set of opaque identifiers meaningful to the user
	Tag []LogicalSwitchTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LogicalSwitchParameters struct {
	...
	// List of IDs of switching profiles (of various types) to be associated with this object. Default switching profiles will be used if not specified
	// +kubebuilder:validation:Optional
	SwitchingProfileID []LogicalSwitchSwitchingProfileIDParameters `json:"switchingProfileId,omitempty" tf:"switching_profile_id,omitempty"`

	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LogicalSwitchTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LogicalSwitchSwitchingProfileIDObservation struct {
...
type LogicalSwitchSwitchingProfileIDParameters struct {
...
type LogicalSwitchTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalSwitchTagParameters struct {
