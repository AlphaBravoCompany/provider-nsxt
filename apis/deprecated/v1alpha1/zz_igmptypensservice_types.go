...
type IgmpTypeNsServiceObservation struct {
	...
	Tag []IgmpTypeNsServiceTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type IgmpTypeNsServiceParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []IgmpTypeNsServiceTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IgmpTypeNsServiceTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IgmpTypeNsServiceTagParameters struct {
