...
type LagObservation struct {
	...
	// uplink names
	Uplink []LagUplinkObservation `json:"uplink,omitempty" tf:"uplink,omitempty"`
}
...
type LagUplinkObservation struct {
	UplinkName *string `json:"uplinkName,omitempty" tf:"uplink_name,omitempty"`

	UplinkType *string `json:"uplinkType,omitempty" tf:"uplink_type,omitempty"`
}

type LagUplinkParameters struct {
}
...
type PolicyUplinkHostSwitchProfileObservation struct {
	...
	Tag []PolicyUplinkHostSwitchProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyUplinkHostSwitchProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []PolicyUplinkHostSwitchProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyUplinkHostSwitchProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyUplinkHostSwitchProfileTagParameters struct {
...
// PolicyUplinkHostSwitchProfileSpec defines the desired state of PolicyUplinkHostSwitchProfile
type PolicyUplinkHostSwitchProfileSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     PolicyUplinkHostSwitchProfileParameters `json:"forProvider"`
}

// PolicyUplinkHostSwitchProfileStatus defines the observed state of PolicyUplinkHostSwitchProfile.
type PolicyUplinkHostSwitchProfileStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        PolicyUplinkHostSwitchProfileObservation `json:"atProvider,omitempty"`
}

// +kubebuilder:object:root=true

// PolicyUplinkHostSwitchProfile is the Schema for the PolicyUplinkHostSwitchProfiles API. <no value>
...
type PolicyUplinkHostSwitchProfile struct {
	...
	Spec   PolicyUplinkHostSwitchProfileSpec   `json:"spec"`
	Status PolicyUplinkHostSwitchProfileStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// PolicyUplinkHostSwitchProfileList contains a list of PolicyUplinkHostSwitchProfiles
type PolicyUplinkHostSwitchProfileList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PolicyUplinkHostSwitchProfile `json:"items"`
}

// Repository type metadata.
var (
	PolicyUplinkHostSwitchProfile_Kind             = "PolicyUplinkHostSwitchProfile"
	PolicyUplinkHostSwitchProfile_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: PolicyUplinkHostSwitchProfile_Kind}.String()
	PolicyUplinkHostSwitchProfile_KindAPIVersion   = PolicyUplinkHostSwitchProfile_Kind + "." + CRDGroupVersion.String()
	PolicyUplinkHostSwitchProfile_GroupVersionKind = CRDGroupVersion.WithKind(PolicyUplinkHostSwitchProfile_Kind)
)

func init() {
	SchemeBuilder.Register(&PolicyUplinkHostSwitchProfile{}, &PolicyUplinkHostSwitchProfileList{})
}
