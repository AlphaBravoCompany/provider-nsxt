...
type PolicyHostTransportNodeProfileObservation struct {
	...
	Tag []PolicyHostTransportNodeProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type PolicyHostTransportNodeProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []PolicyHostTransportNodeProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyHostTransportNodeProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyHostTransportNodeProfileTagParameters struct {
