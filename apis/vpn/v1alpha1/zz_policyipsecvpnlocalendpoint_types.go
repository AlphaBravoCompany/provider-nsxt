...
type PolicyIpsecVpnLocalEndpointObservation struct {
	...
	Tag []PolicyIpsecVpnLocalEndpointTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyIpsecVpnLocalEndpointParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []PolicyIpsecVpnLocalEndpointTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyIpsecVpnLocalEndpointTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyIpsecVpnLocalEndpointTagParameters struct {
