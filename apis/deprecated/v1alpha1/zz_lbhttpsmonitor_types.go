...
type LbHttpsMonitorObservation struct {
	...
	RequestHeader []LbHttpsMonitorRequestHeaderObservation `json:"requestHeader,omitempty" tf:"request_header,omitempty"`
	...
	Tag []LbHttpsMonitorTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbHttpsMonitorParameters struct {
	...
	// Array of HTTP request headers
	// +kubebuilder:validation:Optional
	RequestHeader []LbHttpsMonitorRequestHeaderParameters `json:"requestHeader,omitempty" tf:"request_header,omitempty"`
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LbHttpsMonitorTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type LbHttpsMonitorRequestHeaderObservation struct {
...
type LbHttpsMonitorRequestHeaderParameters struct {
...
type LbHttpsMonitorTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbHttpsMonitorTagParameters struct {
