...
type IpProtocolNsServiceObservation struct {
	...
	Tag []IpProtocolNsServiceTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type IpProtocolNsServiceParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []IpProtocolNsServiceTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpProtocolNsServiceTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type IpProtocolNsServiceTagParameters struct {
