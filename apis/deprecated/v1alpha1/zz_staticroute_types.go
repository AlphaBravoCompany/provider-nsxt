...
type StaticRouteObservation struct {
	...
	Tag []StaticRouteTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type StaticRouteParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []StaticRouteTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type StaticRouteTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type StaticRouteTagParameters struct {
