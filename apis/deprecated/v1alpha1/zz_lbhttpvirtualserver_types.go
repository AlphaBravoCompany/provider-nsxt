...
type LbHttpVirtualServerObservation struct {
	...
	Tag []LbHttpVirtualServerTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type LbHttpVirtualServerParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LbHttpVirtualServerTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbHttpVirtualServerTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LbHttpVirtualServerTagParameters struct {
