...
type LogicalTier1RouterFirewallSectionsObservation struct {
...
type LogicalTier1RouterFirewallSectionsParameters struct {
...
type LogicalTier1RouterObservation struct {
	...
	FirewallSections []LogicalTier1RouterFirewallSectionsObservation `json:"firewallSections,omitempty" tf:"firewall_sections,omitempty"`
	...
	Tag []LogicalTier1RouterTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type LogicalTier1RouterParameters struct {
	...
	// List of Firewall sections related to the logical router
	// +kubebuilder:validation:Optional
	FirewallSections []LogicalTier1RouterFirewallSectionsParameters `json:"firewallSections,omitempty" tf:"firewall_sections,omitempty"`

	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LogicalTier1RouterTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalTier1RouterTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalTier1RouterTagParameters struct {
