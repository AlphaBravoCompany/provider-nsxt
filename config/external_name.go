...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"nsxt_edge_high_availability_profile":                      config.IdentifierFromProvider,
	"nsxt_edge_transport_node":                                 config.IdentifierFromProvider,
	...
	"nsxt_node_user":                                           config.IdentifierFromProvider,
	...
	"nsxt_policy_compute_sub_cluster":                          config.IdentifierFromProvider,
	...
	"nsxt_policy_host_transport_node":                          config.IdentifierFromProvider,
	"nsxt_policy_host_transport_node_collection":               config.IdentifierFromProvider,
	...
	"nsxt_policy_ldap_identity_source":                         config.IdentifierFromProvider,
...
// "nsxt_policy_ospf_area":                                     config.IdentifierFromProvider, // cannot build types for PolicyOspfArea: cannot build the Types: got type "*float64" for field "KeyID", only types "string", "*string", []string, []*string, "map[string]string" and "map[string]*string" supported as sensitive
	...
	"nsxt_policy_uplink_host_switch_profile":                   config.IdentifierFromProvider,
	"nsxt_policy_user_management_role":                         config.IdentifierFromProvider,
	"nsxt_policy_user_management_role_binding":                 config.IdentifierFromProvider,
	...
	"nsxt_policy_vtep_ha_host_switch_profile":                  config.IdentifierFromProvider,
	"nsxt_principal_identity":                                  config.IdentifierFromProvider,
