...
type LogicalTier0RouterObservation struct {
	...
	Tag []LogicalTier0RouterTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type LogicalTier0RouterParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LogicalTier0RouterTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalTier0RouterTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalTier0RouterTagParameters struct {
