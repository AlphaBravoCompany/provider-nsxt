...
type LogicalDhcpPortObservation struct {
	...
	Tag []LogicalDhcpPortTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type LogicalDhcpPortParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []LogicalDhcpPortTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalDhcpPortTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type LogicalDhcpPortTagParameters struct {
