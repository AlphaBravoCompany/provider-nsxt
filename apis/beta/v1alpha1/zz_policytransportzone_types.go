...
type PolicyTransportZoneObservation struct {
	...
	Tag []PolicyTransportZoneTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyTransportZoneParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []PolicyTransportZoneTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
...
type PolicyTransportZoneTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type PolicyTransportZoneTagParameters struct {
