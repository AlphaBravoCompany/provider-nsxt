...
type MacManagementSwitchingProfileObservation struct {
	...
	Tag []MacManagementSwitchingProfileTagObservation `json:"tag,omitempty" tf:"tag,omitempty"`
}
...
type MacManagementSwitchingProfileParameters struct {
	...
	// Set of opaque identifiers meaningful to the user
	// +kubebuilder:validation:Optional
	Tag []MacManagementSwitchingProfileTagParameters `json:"tag,omitempty" tf:"tag,omitempty"`
}

type MacManagementSwitchingProfileTagObservation struct {
	Scope *string `json:"scope,omitempty" tf:"scope,omitempty"`

	Tag *string `json:"tag,omitempty" tf:"tag,omitempty"`
}

type MacManagementSwitchingProfileTagParameters struct {
